...
public class CustomerController {
    ...
    public String updateProfile(@Valid @ModelAttribute("customer") CustomerDto customerDto,
        ...
        // Fetch the country by name and then fetch cities by this country
        Country selectedCountry = countryService.findByName(customerDto.getCountry());
        List<City> cities = cityService.findByCountry(selectedCountry);
